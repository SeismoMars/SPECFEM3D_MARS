...
!
  ...
  if (CASE_3D .and. iregion_code == IREGION_CRUST_MANTLE .and. .not. SUPPRESS_CRUSTAL_MESH) then
    ...
    if (REGIONAL_MOHO_MESH) then
      !=== Youyi Ruan 11/1/2016 
      ! The original number of layers are fixed to 3 (Tromp et al. GJI
      ! 2010). 
      ! The regional function is hard coded and not flexible if the layers of
      ! crust changes.
      ! Change to 5 layers for Mars to honor the large thickness variation of Mars
      ! crust.
