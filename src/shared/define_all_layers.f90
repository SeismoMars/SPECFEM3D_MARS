...
! define all the layers of the mesh
  ...
  ! new definition of rmins & rmaxs
      ...
      !=== Youyi Ruan 11/16/2016 MARS
      ! Don't devide crust into two regions in depth, over write previous setup to stretch 
      ! all layers in crust instead of top two to honor the moho. 
      ner( 1) = NER_CRUST
      ner( 2) = 0
      !print*, '==================='
      !print*, 'DEBUG: R_EARTH', R_EARTH
      !print*, 'DEBUG: RMIDDLE_CRUST', RMIDDLE_CRUST
      !print*, 'DEBUG: RMOHO_FICTITIOUS_IN_MESHER', RMOHO_FICTITIOUS_IN_MESHER 
      !print*, 'DEBUG: NER_CRUST, ner( 1), ner( 2)', NER_CRUST, ner( 1), ner( 2)
      !print*, '==================='
      !===
      ner( 3) = NER_80_MOHO
      ner( 4) = NER_220_80
  ...
  ! the last region is in the inner core near the center of the Earth
      ...
      !=== Youyi Ruan 11/16/2016 MARS Don't devide crust into two regions in
      ! depth
      r_bottom(1) = RMOHO_FICTITIOUS_IN_MESHER
      print*, 'r_bottom(1) = RMOHO_FICTITIOUS_IN_MESHER: ',r_bottom(1)
      !==================='
  ...
  !=== Youyi Ruan 11/16/2016 MARS Test
  print*, '==================='
  print*, 'DEBUG: in define_all_layers()'
  print*, 'DEBUG: R_EARTH',R_EARTH
  print*, 'DEBUG: RMIDDLE_CRUST', RMIDDLE_CRUST
  print*, 'DEBUG: RMOHO_FICTITIOUS_IN_MESHER', RMOHO_FICTITIOUS_IN_MESHER 
  print*, 'DEBUG: NER_CRUST, ner( 1), ner( 2)', NER_CRUST, ner( 1), ner( 2)
