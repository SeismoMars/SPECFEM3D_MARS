...
!
  ...
  use constants,only: R_EARTH, REFERENCE_MODEL_SOHL !, R_MARS
...
! Gaspard
! In this way we use the MARS MODEL.
! Youyi Ruan  MARS 05/19/16 

if (REFERENCE_1D_MODEL == REFERENCE_MODEL_SOHL) then

  !radius(1)  = R_MARS  ! Surface
  radius(1)  = R_EARTH  ! Surface
  radius(2)  = RMOHO_FICTITIOUS_IN_MESHER !    Moho - 1st Mesh Doubling Interface
  radius(3)  = R80    !      80
  radius(4)  = R220   !     220
  ...
  radius(7)  = R670   !     670
  radius(8)  = R771   !     771
  !radius(9)  = 1800000.0d0 ! 1650 - 2nd Mesh Doubling: Geochemical Layering; Kellogg et al. 1999, Science
  !radius(9)  = 1550000.0d0 ! 1650 - 2nd Mesh Doubling: Geochemical Layering; Kellogg et al. 1999, Science
  radius(9)  = 1650000.0d0  ! 1650 - 2nd Mesh Doubling: Geochemical Layering; Kellogg et al. 1999, Science
  radius(10) = RTOPDDOUBLEPRIME   !     D''
  radius(11) = RCMB   !     CMB
  radius(12) = 1200000.0d0  !    3860 - 3rd Mesh Doubling Interface
  !radius(12) = 1300000.0d0 !    3860 - 3rd Mesh Doubling Interface
  !radius(12) = 1400000.0d0 !    3860 - 3rd Mesh Doubling Interface
  !radius(13) = 480000.0d0  !    5000 - 4th Mesh Doubling Interface
  radius(13) = 610000.0d0   !    5000 - 4th Mesh Doubling Interface
  !radius(13) = 1000000.0d0 !    5000 - 4th Mesh Doubling Interface
  !radius(14) = 50000.0d0   ! Top Central Cube
  !radius(14) = 90000.0d0   ! Top Central Cube
  radius(14) = 395000.d0    ! 100000.0d0   ! Top Central Cube
