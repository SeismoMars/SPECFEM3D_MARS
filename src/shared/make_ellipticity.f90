...
! creates a spline for the ellipticity profile in Mars (Sohl $ Spohn)
! radius and density are non-dimensional
  ...
  double precision, parameter :: R_EARTH_ELLIPTICITY = 3390000.d0
  ! radius of the ocean floor for gravity calculation
  double precision, parameter :: ROCEAN_ELLIPTICITY = 3390000.d0
...
! non-dimensionalize
  ...
  enddo
  ! Youyi Ruan Mars 07/01/2016 No Ocean 
  !do i=627,633
