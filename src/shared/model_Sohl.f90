...
!--------------------------------------------------------------------------------------------------
  ...
  subroutine model_Sohl(myrank,x,rho,drhodr,vp,vs,Qkappa,Qmu,idoubling,CRUSTAL, &
...
!
  ...
  subroutine Sohl_display_outer_core(myrank,x,rho,vp,vs,Qkappa,Qmu,idoubling)
