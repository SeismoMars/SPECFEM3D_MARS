...
! R_EARTH is the radius of the bottom of the oceans (radius of Earth in m)
  ...
  double precision, parameter :: R_EARTH = 3390000.d0
...
! average density in the full Earth to normalize equation
  ...
  double precision, parameter :: RHOAV = 3393.0d0

! Ebru
! Model Spohn MARS
  double precision, parameter :: R_MARS = 3390000.d0
! radius of the MARS in km
  double precision, parameter :: R_MARS_KM = R_MARS / 1000.d0
! average density in the full MARS to normalize equation
  double precision, parameter :: RHOAV_MARS = 3393.0d0
! Ebru_end
...
!---  ETOPO30 30-minute model
! size of topography and bathymetry file
!  integer, parameter :: NX_BATHY = 720,NY_BATHY = 360
! resolution of topography file in minutes
!  integer, parameter :: RESOLUTION_TOPO_FILE = 30
! pathname of the topography file
!  character (len=*), parameter :: PATHNAME_TOPO_FILE = 'DATA/topo_bathy/Marstopo30.bin'

!---  ETOPO30 10-minute model
! size of topography and bathymetry file
  integer, parameter :: NX_BATHY = 2160,NY_BATHY = 1080
! resolution of topography file in minutes
  integer, parameter :: RESOLUTION_TOPO_FILE = 10
! pathname of the topography file
  character (len=*), parameter :: PATHNAME_TOPO_FILE = 'DATA/topo_bathy/Marstopo10.bin'
...
! (see e.g. http://en.wikipedia.org/wiki/World_Geodetic_System) has f = 1/298.2572236.
  ...
  double precision, parameter :: FLATTENING_F = 1.d0 / 169.8d0
...
! we take a safety margin just in case of a smoothed or modified model, which can locally create slightly different values
  integer, parameter :: TOPO_MINIMUM = - 8000 ! (max depth in m, Mariana trench)
  integer, parameter :: TOPO_MAXIMUM = + 23200 ! (height in m, Mount Everest)
...
!EBRU
! MARS Youyi
  double precision, parameter :: DEPTH_SECOND_DOUBLING_OPTIMAL = 1200000.d0
  ! Youyi MARS 09/28/2015
  !double precision, parameter :: DEPTH_THIRD_DOUBLING_OPTIMAL  = 2350000.d0
  !double precision, parameter :: DEPTH_FOURTH_DOUBLING_OPTIMAL = 2780000.d0
  ! Youyi MARS 10/03/2015
  double precision, parameter :: DEPTH_THIRD_DOUBLING_OPTIMAL  = 2090000.d0
  double precision, parameter :: DEPTH_FOURTH_DOUBLING_OPTIMAL = 2690000.d0

  !double precision, parameter :: DEPTH_THIRD_DOUBLING_OPTIMAL  = 1889000.d0
  !double precision, parameter :: DEPTH_FOURTH_DOUBLING_OPTIMAL = 2090000.d0
...
!  double precision, parameter :: STANDARD_GRAVITY_EARTH = 9.80665d0 ! in m.s-2
  double precision, parameter :: STANDARD_GRAVITY_EARTH = 3.71d0 ! in m.s-2
...
!  double precision, parameter :: R_DEEPEST_CRUST = (R_EARTH - 80000.d0) / R_EARTH
  double precision, parameter :: R_DEEPEST_CRUST = (R_EARTH - 150000.d0) / R_EARTH
...
! define flag for reference 1D Earth model
  ...
  integer, parameter :: REFERENCE_MODEL_SOHL = 8
...
! number of hours per day for rotation rate of the Mars (24:39:35)
  double precision, parameter :: HOURS_PER_DAY = 24.658d0
...
!  and RMIDDLE_CRUST to become 15 km with stretching function stretch_tab)
  double precision, parameter :: MAX_RATIO_CRUST_STRETCHING = 0.7d0 ! 0.75
  double precision, parameter :: RMOHO_STRETCH_ADJUSTMENT = -10000.d0 ! moho down to 120 km
  double precision, parameter :: R80_STRETCH_ADJUSTMENT =   -20000.d0 ! r80 down to 120km

! adapted regional moho stretching
! 1 chunk simulations, 3-layer crust
! Youyi MARS 10/02/2015  
